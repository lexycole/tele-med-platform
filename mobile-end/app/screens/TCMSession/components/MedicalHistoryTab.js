...
import { AppMultiDropdown, AppSingleDropdown } from "../../../components/forms";
...
const MedicalHistoryTab = ({ handleSubmitToDB, diseasesConditions }) => {
  ...
  const { medicalHistory, isMedical, isEdit } = useSnapshot(tcmState);
  const isUpdate = useRef(isMedical).current;
  ...
  const handleSubmit = (values) => {
    ...
    tcmState.medicalHistory = filterd;
        ...
        {({ handleChange, handleBlur, setFieldValue, handleSubmit, values, errors }) => (
          <View style={styles.container}>
            ...
            <AppTextInput
              ...
              onChangeText={handleChange("medicaments")}
              editable={isEdit ? true : false}
            />
            ...
            >
              ...
              <Button
                style={{
                  marginLeft: isUpdate && isEdit ? 10 : 0,
                  width: isUpdate && isEdit
                    ? isTablet
                      ? 150
                      : "45%"
                    : isTablet
