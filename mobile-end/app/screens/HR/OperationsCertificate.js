...
// import certificatesApi, { saveCertificate } from "../../api/certificates";
...
const validationSchema = Yup.object().shape({
  ...
  certificateNo: Yup.string().optional("Optional"),
...
const OperationsCertificate = ({ route, navigation }) => {
...
// 
  useEffect(() => {
    ...
    if (route.params) {
      setSelectedCertificate(route.params.selectedCertificate);
      console.log(route);
    }
  ...
  const handleSubmit = async (userInfo) => {
    ...
    try {
      ...
      // const { ok, data } = await saveCertificate(submitData);
      // setLoading(false)
      // if (!ok) {
...
export default OperationsCertificate;
