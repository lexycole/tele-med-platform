...
// import leavesApi, { saveTicket } from "../../api/leaves";
...
const validationSchema = Yup.object().shape({
  ...
  leaveNo: Yup.string().optional("Optional"),
...
// 
  ...
  const handleSubmit = async (userInfo) => {
    ...
    try {
      ...
      const { ok, data } = await saveLeave(submitData);
      setLoading(false)
      if (!ok) {
              ...
              <>
                ...
                >
                  ...
                  <FormField
                    ...
                    width="100%"
                  />
                    <Text style={{ marginBottom: 5 }}>Free From:</Text>
                    ...
                    />
                    <Text style={{ marginBottom: 5 }}>Free Till:</Text>
