...
// import LeaveReasonsApi, { saveLeaveReason } from "../../api/leavereasons";
...
const OperationsLeaveReason = ({ route, navigation }) => {
...
// 
  useEffect(() => {
    ...
    if (route.params) {
      setSelectedLeaveReason(route.params.selectedLeaveReason);
      console.log(route);
    }
  ...
  const handleSubmit = async (userInfo) => {
    ...
    try {
      ...
      // const { ok, data } = await saveLeaveReason(submitData);
      // setLoading(false)
      // if (!ok) {
      ...
      <View style={styles.Container}>
        ...
        <KeyboardAwareScrollView>
          ...
          <Navbar
            ...
            Text={`${  "Add"} LeaveReason`}
          />
          <ActivityIndicator
            visible={
              loading
              // saveLeaveReasonApi.loading 
...
export default OperationsLeaveReason;
