...
const PatientSelectionSection = ({ setLoading, isEdit }) => {
  ...
  //   console.log(homeoState.selectedPatient);
  // };
  // const { selectedPatient, doctorNo, clinicNo } = useSnapshot(homeoState);
      ...
      >
        {/* {doctorOptions ? ( */}
          ...
          >
            ...
            <Dropdown
              ...
              //   if (ok) homeoState.doctorNo = data[0]._id;
              // }}
              // disabled={isEdit}
            />
          </View>
        ...
        >
          ...
          <Dropdown
            ...
            //   if (ok) homeoState.clinicNo = data[0]._id;
            // }}
            // disabled={isEdit}
          />
        </View>
