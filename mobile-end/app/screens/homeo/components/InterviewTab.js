...
const InterviewTab = ({ handleSubmitToDB }) => {
  ...
  const { interview, isInterview, isEdit } = useSnapshot(homeoState);
  ...
  //     localityOfPain: interview ? interview.localityOfPain : "",
  //     natureOfPain: interview ? interview.natureOfPain : "",
  //     emotionState: interview ? interview.emotionState : [],
  //     noteEmotion: interview ? interview.noteEmotion : "",
  ...
  //     };
  //     ayurvedaState.interview = filterd;
  ...
  const initialValues = {
    ...
    nose: interview ? interview.nose : [],
    throat: interview ? interview.throat : [],
    menstruationHistory: interview ? interview.menstruationHistory : [],
    leukorrhea: interview ? interview.leukorrhea : [],
