...
import { colors } from "../../../components/ayurveda/colors";
...
import { medicalHistory as historyOptions, interviewDropdownValues, inspectionAndExaminationDropdownValues, homeoTreatmentDropdownValues } from "../drowdownItems";
...
// import { updateHomeoPathySession } from "../../../api/sessions";
...
const SessionMoreDetails = ({ modalVisible, setModalVisible, data }) => {
  ...
  const initialValues = {
    ...
    homeoDiagnosis: data.homeoTreatment ? data.homeoTreatment.homeoDiagnosis : "",
    principleTreatment: data.homeoTreatment
      ? data.homeoTreatment.principleTreatment
      : "",
    treatmentNote: data.homeoTreatment ? data.homeoTreatment.treatmentNote : "",
    remedy: data.homeoTreatment ? data.homeoTreatment.remedy : [{ materiaMedica: '', potency: "" }],
    dietTherapy: data.homeoTreatment ? data.homeoTreatment.dietTherapy : "",
    recommendation: data.homeoTreatment ? data.homeoTreatment.recommendation : "",
  };
  ...
  const [menuItems, setMenuItems] = useState([
    ...
    { label: "Homeo Treatment", value: "homeoTreatment" },
              ...
              <View style={{ marginHorizontal: 10 }}>
                ...
                >
                  ...
                  <Button
                    ...
                    title="Next"
                    onPress={() => {
                      setValue("homeoTreatment");
                    }}
                  />
                </View>
              </View>
            )}
            {value === "homeoTreatment" && (
              <View style={{ marginHorizontal: 10 }}>
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                  <Text style={styles.title}>Homeo Treatment</Text>
                  {!isEdit ? (<TouchableOpacity style={{
                    padding: isTablet ? 10 : 5,
                    marginRight: 10,
                    backgroundColor: colors.pickerBackColor,
