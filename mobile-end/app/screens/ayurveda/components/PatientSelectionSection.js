...
const PatientSelectionSection = ({ setLoading, isEdit }) => {
  ...
  //       medicamentsSupplements: filterSessions.medicalHistory.medicamentsSupplements ? filterSessions.medicalHistory.medicamentsSupplements : "",
  ...
  //   console.log(ayurvedaState.selectedPatient);
  // };
  // const { selectedPatient, doctorNo, clinicNo } = useSnapshot(ayurvedaState);
  ...
  return (
    <View style={styles.container}>
      {!isEdit && (
        ...
        >
          <Text
            style={{ marginVertical: 10, width: isTablet ? "55%" : "100%" }}
          >
          ...
          >
            <View style={{flexDirection: "row", justifyContent: "space-between",marginRight: isTablet ? 20 : 0}}>
              ...
              >
                ...
                <AppTextInputDisable
                title={"AApp tECT input diable 3"}
              ...
              >
                ...
                <AppTextInputDisable
                title={"AApp tECT input diable 4"}
      ...
      >
        {/* {doctorOptions ? ( */}
          ...
          >
            ...
            <Dropdown
              ...
              //   if (ok) ayurvedaState.doctorNo = data[0]._id;
              // }}
              // disabled={isEdit}
            />
          </View>
        ...
        >
          ...
          <Dropdown
            ...
            //   if (ok) ayurvedaState.clinicNo = data[0]._id;
            // }}
            // disabled={isEdit}
          />
        </View>
