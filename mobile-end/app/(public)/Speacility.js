...
class Speacility extends Component {
  state = {
    data: [
      { name: "Dr. John Doe", specility: "Cardiologist" },
      { name: "Dr. John Doe", specility: "Cardiologist" },
      { name: "Dr. John Doe", specility: "Cardiologist" },
      { name: "Dr. John Doe", specility: "Cardiologist" },
      { name: "Dr. John Doe", specility: "Cardiologist" },
  ...
  renderItem2 = (item) => (
    <TouchableOpacity
      onPress={() => {
        this.props.navigation.navigate("Cardiolist");
      }}
    ...
    >
      ...
      <View style={styles.RightContaner}>
        <Text style={styles.DocnameText}>{item.specility}</Text>
        <Text style={styles.SpeciltyTexts}>12 Consultants</Text>
      </View>
        ...
        <View style={styles.TopContainer}>
          <View style={styles.ContainerForPic}>
            ...
            <View style={styles.TopMiddleContianer}>
              <Text style={styles.ConsultantText}>Specialties</Text>
            </View>
          </View>
          <SearchBar />
        </View>
