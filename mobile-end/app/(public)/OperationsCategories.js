...
// import categorysApi, { saveCategory } from "../../api/categories";
...
import { AppMultiDropdown } from "../screens/homeo/components/InterviewTab";
import _ from "lodash";

const validationSchema = Yup.object().shape({
  name: Yup.string().required("Required"),
  narrative: Yup.string().required("Required"),
  categoryNo: Yup.string().required("Required"),
...
const OperationsCategory = ({ route, navigation }) => {
  ...
  //     setInitialState({
  //       ...selectedCategory,
  //       participants: selectedCategory.participants.map((item) => item._id),
  //       user: user?._id,
  //       categoryNo: makeCategoryNo(),
  //     });
  //   }
  // }, [selectedCategory]);
  ...
  //   try {
  //     const { ok, data } = await saveCategory(submitData);
  //     console.log(ok)
  //     setLoading(false);
  //     if (!ok) {
  ...
  //       return;
  //     }
  //     alert(submitData._id ? "Category Updated" : "Category added");
      ...
      <View style={styles.Container}>
        ...
        <KeyboardAwareScrollView>
          ...
          <Navbar
            ...
            // Text={!_.isEmpty(selectedCategory) ? "Edit Category" : "Add Category"}
          />
          {/* <ActivityIndicator
            visible={
              loading
               saveCategoryApi.loading
