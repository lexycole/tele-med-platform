...
function OperationsCompany ({ route, navigation }) {
  // const [selected, setSelected] = useState({});

  // const companyApi = useApi(companiesApi.saveCompany);
  // const getCountriesApi = useApi(countries.getCountries);
  // const [error, setError] = useState();

  // useEffect(() => {
  //   if (route.params) {
  //     setSelected(route.params.selectedCompany);
  //   }
  ...
  //       submitData["_id"] = _id;
  //     }
  //     const result = await companyApi.request(submitData);
      ...
      <View style={styles.Container}>
        ...
        <KeyboardAwareScrollView>
          ...
          {/* <Navbar
            ...
            Text={`${_id ? "Update" : "Add"} Company`}
          />

          <ActivityIndicator
            visible={companyApi.loading || getCountriesApi.loading}
          /> */}
...
export default OperationsCompany;
