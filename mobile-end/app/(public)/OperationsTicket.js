...
// import ticketsApi, { saveTicket } from "../../src/api/tickets";
...
const validationSchema = Yup.object().shape({
  ...
  category: Yup.string().required("Optional").label("category"),
  subCategory: Yup.string().required("Optional").label("subCategory"),
  deadline: Yup.string().optional("Optional").label("deadline"),
  
  ticketNo: Yup.string().optional("Optional"),
...
const OperationsTicket = ({ route, navigation }) => {
  // const makeTicketNo = () => {
  //   let ticketNumber = "TK-";
  ...
  //     setInitialState({
  //       ...selectedTicket,
  //       participants: selectedTicket.participants.map((item) => item._id),
  //       user: user?._id,
  //       ticketNo: makeTicketNo(),
  //     });
  //   }
  ...
  //   try {
  //     const { ok, data } = await saveTicket(submitData);
  //     console.log(ok)
  //     setLoading(false);
  //     if (!ok) {
  ...
  //       return;
  //     }
  //     alert(submitData._id ? "Ticket Updated" : "Ticket added");
      ...
      <View style={styles.Container}>
        ...
        <KeyboardAwareScrollView>
          ...
          <Navbar
            ...
            // Text={!_.isEmpty(selectedTicket) ? "Edit Ticket" : "Add Ticket"}
          />
          {/* <ActivityIndicator
            visible={
              loading
              saveTicketApi.loading
              ...
              >
                <>
                  ...
                  >
                    ...
                    {/* <FormField placeholder="Name" Header="Name"  autoCapitalize="none" secureTextEntry={false} isMultiline={false} name="name" width="100%"/>
                    <FormField placeholder="Business Name" Header="Business Name" secureTextEntry={false} isMultiline={false} name="businessName" width="100%" />
                    <FormField placeholder="Department" Header="Department" secureTextEntry={false} isMultiline={false} name="department" width="100%" />
                    <FormField placeholder="Sub Department" Header="Sub Department" secureTextEntry={false} isMultiline={false} name="subDepartment" width="100%" />
                    <FormField placeholder="Tags" Header="Tags" secureTextEntry={false} isMultiline={false} name="tags" width="100%" />
                    <FormField placeholder="Locations" Header="Locations" secureTextEntry={false} isMultiline={false} name="locations" width="100%" />
                    <FormField placeholder="DocumentNo" Header="DocumentNo" secureTextEntry={false} isMultiline={false} name="documentNo" width="100%" />
                    <FormField placeholder="Field" Header="Field" secureTextEntry={false} isMultiline={false} name="field" width="100%" /> 
                    <FormField placeholder="Reference" Header="Reference" secureTextEntry={false} isMultiline={false} name="reference" width="100%" />
                    <FormField placeholder="Note" Header="Note" secureTextEntry={false} isMultiline={false} name="note" width="100%" />
                    <FormField placeholder="Narrative" Header="Narrative" secureTextEntry={false} isMultiline={true} multiline numberOfLines={2} name="narrative" 
                    ...
                    >
                      <Text>Priority</Text>
                      {/* <FormPicker textInputPlaceholder="Select Priority" data={priorityOptions} mode="flat" name="priority" /> */}
                    </View>
                    <View
                      style={{
                        height: 64,
                    ...
                    >
                      <Text>Category</Text>
                      {/* <FormPicker textInputPlaceholder="Select Category" data={categoryOptions} mode="flat" name="category" enableAvatar={false} /> */}
                    </View>
                    {/* <FormField placeholder="Sub Category" Header="Sub Category" secureTextEntry={false} isMultiline={false} name="subCategory" width="100%" />					 */}
                    ...
                    >
                      <Text>Status</Text>
                      {/* <FormPicker textInputPlaceholder="Select Status" data={statusOptions} mode="flat"  name="status" /> */}
                    </View>
                  </View>
...
export default OperationsTicket;
