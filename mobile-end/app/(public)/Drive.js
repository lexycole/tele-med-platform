...
import CButton from "../screens/Drive/components/CButton";
import Menu from "../screens/Drive/components/Menu";
import Folder from "../screens/Drive/components/Folder";
import { optionsArray, data, fileOptions, menuOptions } from "../screens/Drive/constants";
...
//   deleteItems,
// } from "../../api/drive";
import CHeader from "../screens/Drive/components/CHeader";
import SideItem from "../screens/Drive/components/SideItem";

import FileView from "../screens/Drive/components/FileView";
...
function Drive({ navigation }) {
  ...
  //   setLoading(true);
  //   if (ok) {
  //     setUploadedFiles(data.children);
  //     setLoading(false);
  //   }
  // };
  ...
  //       const path = selectedMenu ? selectedMenu.path : "/";
