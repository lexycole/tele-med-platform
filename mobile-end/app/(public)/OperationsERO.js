...
function OperationsERO ({ route, navigation }) {
  // const [selected, setSelected] = useState({});

  // const eroApi = useApi(erosApi.saveERO);
  ...
  //     }
  //     const result = await eroApi.request(submitData);
  ...
  //     Alert.alert(`ERO ${ id ? "updated" : "added" } successfully`);
  //     navigation.goBack();
  //   } catch (error) {
              ...
              > */}
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Icon name="card-account-details" size={24} />
                      <Title style={{ fontWeight: "bold", marginLeft: 8 }}>
                        Membership
                      </Title>
                    </View>
