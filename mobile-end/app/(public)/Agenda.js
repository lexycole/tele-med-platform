...
import colors from "../screens/Planning/colors"; 
import OperationsAppointment from "../screens/Planning/OperationsAppointment";
...
export default function Agenda({ navigation,route }) {
  ...
  ), [isTablet, showDatepicker, setAppointmentModal, router]);
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity
        onPress={() => router.push({ pathname: "/appointmentInfo", params: { item: item } })}
        activeOpacity={0.8}
        style={{
